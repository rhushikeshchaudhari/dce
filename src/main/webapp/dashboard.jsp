...
<head>
	...
	<title>DCE-CO-CSL - Dashboard</title>
...
<body>
	<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>DCE-CO-CSL Admin</span></a>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="index.html"><em class="fa fa-user">&nbsp;</em> Customer Onboarding</a></li>
			<li><a href="widgets.html"><em class="fa fa-money">&nbsp;</em> Share & MD</a></li>
			<li><a href="charts.html"><em class="fa fa-bar-chart">&nbsp;</em> Loan </a></li>
			<li><a href="elements.html"><em class="fa fa-toggle-off">&nbsp;</em> Reports</a></li>
	...
	<script src="${contextPath}/resources/js/chart-data.js"></script>
